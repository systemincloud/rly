...
- define what R code should be executed as a language file (e.g. a program) is parsed.
...
We can build a "lexer" to pull out URLs from text input. Sure, we could just use `stringi::stri_match_all_regex()` for this particular example, but the intent it to work with a known, straightforward domain to see how "lexing" works:
