...
test_that("missing regex", {
  expect_error(rly::yacc(Parser1), "ERROR> Rule 'p_statement_assign' has too many arguments")
  expect_error(rly::yacc(Parser2), "ERROR> Rule 'p_statement_expr' requires an argument")
})
