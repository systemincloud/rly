...
context("Grammar with an unused rule")
...
Parser <- R6Class("Parser",
  public = list(
    ...
    p_integer = function(doc='integer : NUMBER', t) {
      t[0] = t[1]
    },
    p_error = function(t) {
...
test_that("grammar", {
  expect_output(rly::yacc(Parser), "WARN>  Rule integer defined, but not used \nWARN>  There is 1 unused rule", fixed=TRUE)
})
