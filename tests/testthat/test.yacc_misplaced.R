...
context("A misplaced | in grammar rules")
...
Parser <- R6Class("Parser",
  public = list(
    ...
    p_expression_binop = function(doc='| expression PLUS expression
...
test_that("error", {
  expect_error(rly::yacc(Parser), "ERROR> p_expression_binop: Misplaced '|'", fixed=TRUE)
})
