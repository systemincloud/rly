...
context("p_rule not defined as a function")
...
test_that("not function", {
  expect_output(rly::yacc(Parser), "WARN>  p_statement_assign not defined as a function", fixed=TRUE)
})
