...
context("No p_error() rule defined")
...
test_that("error", {
  expect_error(rly::yacc(Parser), "ERROR> No documentation string specified in function p_statement_expr'", fixed=TRUE)
})
