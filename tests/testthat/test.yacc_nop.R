...
context("Possible grammar rule defined without p_ prefix")
...
Parser <- R6Class("Parser",
  public = list(
    ...
    statement_expr = function(doc='statement : expression', t) {
      cat(t[1])
    },
...
test_that("no p", {
  expect_output(rly::yacc(Parser), "WARN>  statement_expr: Possible grammar rule defined without p_ prefix", fixed=TRUE)
})
