...
Parser <- R6Class("Parser",
  public = list(
    ...
    p_expression_uminus = function(doc='expression : MINUS expression %prec', t) {
      t[0] <- -t[2]
    },
...
test_that("prec", {
  expect_error(rly::yacc(Parser), "ERROR> p_expression_uminus: Syntax error. Nothing follows %prec", fixed=TRUE)
})
